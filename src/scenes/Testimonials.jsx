        ...
        <section id="testimonials" className="pt-32 pb-16">
            ...
            >
                <p className="font-playfair font-semibold text-4xl mb-5 text-red">
                    ...
                    <p className="mt-10">
                        Bring to the table win-win technical strategies to ensure proactive stability and scalability.
                    </p>
                </p>
            </motion.div>
            ...
            <div className="md:flex md:justify-between gap-8">
                <motion.div
                    className={`bg-tan ${testimonialStyles} before:content-person1`}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5}}
                    transition= {{ duration: 0.5 }}
                ...
                <motion.div
                    className={`bg-ruby ${testimonialStyles} before:content-person3`}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5}}
